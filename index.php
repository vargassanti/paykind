...
$sentencia = $conexion->prepare("SELECT * FROM `tbl_productos` LIMIT 25");
$sentencia->execute();
...
if (isset($_GET['txtID'])) {
    ...
    $sentencia = $conexion->prepare("DELETE FROM tbl_tiendas WHERE nit_identificacion=:nit_identificacion");
    $sentencia->bindParam(":nit_identificacion", $txtID);
    $sentencia->execute();
    $mensaje = "Registro eliminado";
    header("location:index.php?mensaje=" . $mensaje);
}
...
<body>
            ...
            <li>
                ...
                ?>
                            ...
                            <ul class="sub-menu">
                                ...
                                <?php
                                $sentencia = $conexion->prepare("SELECT * FROM `tbl_categorias` LIMIT 10");
                                $sentencia->execute();
    ...
    <div class="swiper swiper-hero">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <img src="https://http2.mlstatic.com/D_NQ_939987-MLA50832730063_072022-OO.webp" alt="" />
            </div>
            <div class="swiper-slide">
                <img src="https://http2.mlstatic.com/D_NQ_817829-MLA50860384312_072022-OO.webp" alt="" />
            </div>
            <div class="swiper-slide">
                <img src="https://http2.mlstatic.com/D_NQ_955859-MLA50696530729_072022-OO.webp" alt="" />
            </div>
            <div class="swiper-slide">
                <img src="https://http2.mlstatic.com/D_NQ_999003-MLA50928299324_072022-OO.webp" alt="" />
            </div>
            <div class="swiper-slide">
                <img src="https://http2.mlstatic.com/D_NQ_954078-MLA50783791927_072022-OO.webp" alt="" />
            </div>
        </div>
    ...
    <div class="imagen_logo">
        <a href="https://wa.link/3tma07" target="_blank">
            <img src="img/Anotación_2023-11-15_151656-removebg-preview.png" alt="Logo">
        </a>
    </div>

    <div class="ofertas">
        <h2 class="h2_oferta">Productos subidos</h2>
        <a class="a_oferta" href="secciones/productos/">Ver mas...</a>
    </div>
    <div class="Carousel">
        <div class="slick-list" id="slick-list">
            ...
            <div class="slick-track" id="track">
                ...
                ?>
                        <div class="slick">
                            <div>
                                <a href="secciones/productos/info_producto.php?txtID=<?php echo $registro['id_producto']; ?>&token=<?php echo hash_hmac('sha1', $registro['id_producto'], KEY_TOKEN); ?>&ruta=../../index.php">
                                    <h4>
                                        <small>
                                    ...
                                    <picture>
                                        <img class="tamaño_imagen_carrusel" src="secciones/productos/imagenes_producto/<?php echo $registro['img_producto']; ?>" alt="" />
                                    </picture>
                                </a>
                            </div>
                        </div>
    ...
    <div class="ofertas2">
        <h2 class="h2_oferta2">Ofertas</h2>
        <a class="a_oferta2" href="secciones/productos/ofertas.php">Ver mas...</a>
    </div>
    <div class="Carousel2">
        <div class="slick-list" id="slick-list">
            <button class="slick-arrow slick-prev" id="button-prev" data-button="button-prev" onclick="app.processingButton(event)">
    ...
    <div class="ofertas4">
        <h2 class="h2_oferta">Tiendas registradas</h2>
        <a class="a_oferta4" href="secciones/tiendas/">Ver mas...</a>
    </div>
    <div class="Carousel3">
        <div class="slick-list" id="slick-list">
            <button class="slick-arrow slick-prev" id="button-prev" data-button="button-prev" onclick="app.processingButton(event)">
            ...
            <div class="slick-track" id="track">
                ...
                ?>
                    <div class="slick">
                        <div>
                            <a href="secciones/tiendas/mas_tienda.php?txtID=<?php echo $registro['nit_identificacion']; ?>&ruta=../../index.php">
                                <h4><?php echo $registro['nombre_tienda']; ?></h4>
                                <picture>
                                    <img src="./secciones/tiendas/imagenes_tienda/<?php echo $registro['logo_tienda']; ?>" />
                                </picture>
                            </a>
                        </div>
                    </div>
    ...
    <script src="js/nombre_usuario.js"></script>
    ...
    ?>
        <script>
            ...
            Toast.fire({
                icon: 'success',
                title: '<?php echo $_GET['mensaje_bienvenida']; ?>'
            })
        </script>
    <?php
        // Marca la alerta de bienvenida como mostrada
        $_SESSION['alerta_bienvenida_mostrada'] = true;
    }
    ?>
    <script>
    ...
    <footer>
        ...
        <div class="container__footer">
            ...
            <div class="contact-info">
                <p><a href="https://wa.link/3tma07" target="_blank"><i class='bx bxl-whatsapp'></i></a></p>
                <p><a href="https://www.facebook.com/Paykind.com.co" target="_blank"><i class='bx bxl-facebook'></i></a></p>
                <p><a href="https://www.instagram.com/paykind/" target="_blank"><i class='bx bxl-instagram'></i></a></p>
                <p><a href="https://www.youtube.com/channel/UCBBk3vikC8WSmOs8-1ahIhA" target="_blank"><i class='bx bxl-youtube'></i></a></p>
                <p><a href="mailto:servicioalclientepaykind@gmail.com?subject=Asunto del correo&body=Cuerpo del correo"><i class='bx bx-envelope'></i></a></p>
            </div>
            <div class="about-us">
                <h2>QUIÉNES SOMOS</h2>
                <ul>
