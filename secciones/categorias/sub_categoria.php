...
if (isset($_GET['id'])) {
    ...
    $subcategoria_query = $conexion->prepare("SELECT * FROM tbl_productos WHERE id_sub_categoria=:id_sub_categoria");
        ...
        foreach ($registro_recuperado as $producto) {
            if ($producto['estado_producto'] == "Activo") { ?>
                <div class="caja2">
                    ...
                    <a href="../productos/info_producto.php?txtID=<?php echo $producto['id_producto']; ?>&token=<?php echo hash_hmac('sha1', $producto['id_producto'], KEY_TOKEN); ?>&ruta=../categorias/sub_categoria.php?id=<?php echo $sub_categoria_id ?>">
