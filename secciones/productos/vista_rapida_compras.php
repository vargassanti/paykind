        ...
        <div class="contenedor-compra">
            <?php foreach ($informacion_compra as $detalles) { ?>
                <div class="informacion_del_producto">
                    ...
                    <p>Imagen producto: </p>
                    <img class="imagenn" src="imagenes_producto/<?php echo $detalles['img_producto'] ?>" alt="">
            ...
            <div class="informacion_del_pago">
                ...
                if ($detalles['metodo_pago'] == 'Efectivo') {
                    ...
                    <img class="imagenn_comprobante" src="../carrito/imagenes_transferencia/<?php echo $detalles['imagen_tranferencia'] ?>">
                <?php } ?>
